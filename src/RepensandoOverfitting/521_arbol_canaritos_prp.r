...
setwd( "/Users/flaviamunafo/Desktop/mineriadedatos" )  #establezco la carpeta donde voy a trabajar
#cargo el dataset
...
setwd("/Users/flaviamunafo/Desktop/mineriadedatos/labo/exp/ST5210")   #Establezco el Working Directory DEL EXPERIMENTO

...
ksemillas  <- c(230701, 301255, 595781, 198723, 379107) #reemplazar por las propias semillas
...
ArbolEstimarGanancia  <- function( semilla, param_basicos )
{
  ...
  particionar( dataset, division=c(70,30), agrupa="clase_ternaria", seed= 230701 )  #Cambiar por la primer semilla de cada uno !
...
{
for( vmin_split  in  c( 500, 400, 300, 200, 100 )  )
{
for( vcp  in  c( -4, -6, -8, -10, -12)  )
{
for( vminbucket  in  c( 500, 600, 700, 800, 900)  )
{

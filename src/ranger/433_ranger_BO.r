...
ksemilla_azar  <- 230701  #Aqui poner la propia semilla
...
particionar  <- function( data, division, agrupa="", campo="fold", start=1, seed=230701 )
{
...
setwd("/Users/flaviamunafo/Desktop/mineriadedatos/labo/exp/HT4330")   #Establezco el Working Directory DEL EXPERIMENTO
